...
#define SIGNALING_ACCEPT_STATE_NEW            SIGNALING_STATE_NONE | SIGNALING_STATE_NEW
#define SIGNALING_ACCEPT_STATE_GET_TOKEN      SIGNALING_STATE_NEW | SIGNALING_STATE_DESCRIBE |  \
                                                SIGNALING_STATE_CREATE | SIGNALING_STATE_GET_ENDPOINT |  \
                                                SIGNALING_STATE_GET_ICE_CONFIG | SIGNALING_STATE_READY | \
                                                SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED | \
                                                SIGNALING_STATE_DELETE | SIGNALING_STATE_GET_TOKEN
#define SIGNALING_ACCEPT_STATE_DESCRIBE       SIGNALING_STATE_GET_TOKEN | SIGNALING_STATE_CREATE | \
                                                SIGNALING_STATE_GET_ENDPOINT | SIGNALING_STATE_GET_ICE_CONFIG | \
                                                SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED | \
                                                SIGNALING_STATE_DELETE | SIGNALING_STATE_DESCRIBE
#define SIGNALING_ACCEPT_STATE_CREATE         SIGNALING_STATE_DESCRIBE | SIGNALING_STATE_CREATE
#define SIGNALING_ACCEPT_STATE_GET_ENDPOINT   SIGNALING_STATE_DESCRIBE | SIGNALING_STATE_CREATE | \
                                                SIGNALING_STATE_GET_TOKEN | SIGNALING_STATE_READY | SIGNALING_STATE_CONNECT | \
                                                SIGNALING_STATE_CONNECTED | SIGNALING_STATE_GET_ENDPOINT
#define SIGNALING_ACCEPT_STATE_GET_ICE_CONFIG SIGNALING_STATE_DESCRIBE | SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED | \
                                                SIGNALING_STATE_GET_ENDPOINT | SIGNALING_STATE_READY | SIGNALING_STATE_GET_ICE_CONFIG
#define SIGNALING_ACCEPT_STATE_READY          SIGNALING_STATE_GET_ICE_CONFIG | SIGNALING_STATE_DISCONNECTED | SIGNALING_STATE_READY
#define SIGNALING_ACCEPT_STATE_CONNECT        SIGNALING_STATE_READY | SIGNALING_STATE_DISCONNECTED | SIGNALING_STATE_CONNECTED | SIGNALING_STATE_CONNECT
#define SIGNALING_ACCEPT_STATE_CONNECTED      SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED
#define SIGNALING_ACCEPT_STATE_DISCONNECTED   SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED
#define SIGNALING_ACCEPT_STATE_DELETE         SIGNALING_STATE_GET_TOKEN | SIGNALING_STATE_DESCRIBE | SIGNALING_STATE_CREATE | \
                                                SIGNALING_STATE_GET_ENDPOINT | SIGNALING_STATE_GET_ICE_CONFIG | SIGNALING_STATE_READY | \
                                                SIGNALING_STATE_CONNECT | SIGNALING_STATE_CONNECTED | SIGNALING_STATE_DISCONNECTED | \
                                                SIGNALING_STATE_DELETE
#define SIGNALING_ACCEPT_STATE_DELETED        SIGNALING_STATE_DELETE | SIGNALING_STATE_DELETED
