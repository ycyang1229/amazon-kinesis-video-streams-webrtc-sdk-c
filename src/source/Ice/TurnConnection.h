...
STATUS turnConnectionCreate(PIceServer, TIMER_QUEUE_HANDLE, TURN_CONNECTION_DATA_TRANSFER_MODE, KVS_SOCKET_PROTOCOL, PTurnConnectionCallbacks,
                            PSocketConnection, PConnectionListener, PTurnConnection*);
STATUS turnConnectionFree(PTurnConnection*);
...
STATUS turnConnectionFsmStep(PTurnConnection);
