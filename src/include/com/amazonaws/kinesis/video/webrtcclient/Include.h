...
#define STATUS_RSA_CERTIFICATE_GENERATION_FAILED          STATUS_DTLS_BASE + 0x00000001
#define STATUS_ECP_CERTIFICATE_GENERATION_FAILED          STATUS_DTLS_BASE + 0x00000002
#define STATUS_SSL_CTX_CREATION_FAILED                    STATUS_DTLS_BASE + 0x00000003
#define STATUS_SSL_REMOTE_CERTIFICATE_VERIFICATION_FAILED STATUS_DTLS_BASE + 0x00000004
#define STATUS_SSL_PACKET_BEFORE_DTLS_READY               STATUS_DTLS_BASE + 0x00000005
