 ...
 */
typedef enum {
    ICE_CANDIDATE_TYPE_HOST = 0,             //!< ICE_CANDIDATE_TYPE_HOST, local.
    ICE_CANDIDATE_TYPE_PEER_REFLEXIVE = 1,   //!< ICE_CANDIDATE_TYPE_PEER_REFLEXIVE, remote.
    ICE_CANDIDATE_TYPE_SERVER_REFLEXIVE = 2, //!< ICE_CANDIDATE_TYPE_SERVER_REFLEXIVE, stun server.
    ICE_CANDIDATE_TYPE_RELAYED = 3,          //!< ICE_CANDIDATE_TYPE_RELAYED, turn server.
} ICE_CANDIDATE_TYPE;
...
typedef struct {
    ...
    UINT32 numberOfErrors;           //!< Number of signaling client API call failures.
                                     ...
                                     //!< createSignalingClient and freeSignalingClient invocation
